...
def create_experiment_files():
    ...
    # E017A Fresh
    with open("experiments/E017A_Fresh.py", "w") as f:
        f.write("from .E017_Base import Actor as BaseActor\n")
        f.write("class Actor(BaseActor):\n")
        f.write("    def __init__(self, seed: int):\n")
        f.write("        super().__init__(seed=seed, keep_q=False, keep_n=False, keep_buffer=False)\n")
    experiments.append("E017A_Fresh")
    
    # E017B Persistent Q (Semantic)
    with open("experiments/E017B_PersistentSemantic.py", "w") as f:
        f.write("from .E017_Base import Actor as BaseActor\n")
        f.write("class Actor(BaseActor):\n")
        f.write("    def __init__(self, seed: int):\n")
        f.write("        super().__init__(seed=seed, keep_q=True, keep_n=False, keep_buffer=False)\n")
    experiments.append("E017B_PersistentSemantic")
    
    # E017C Persistent Full Memory
    with open("experiments/E017C_PersistentFull.py", "w") as f:
        f.write("from .E017_Base import Actor as BaseActor\n")
        f.write("class Actor(BaseActor):\n")
        f.write("    def __init__(self, seed: int):\n")
        f.write("        super().__init__(seed=seed, keep_q=True, keep_n=True, keep_buffer=True)\n")
    experiments.append("E017C_PersistentFull")
...
def main():
    ...
    for exp in experiments:
        out_dir = f"logs/batch_0017/{c_name}/{exp}"
