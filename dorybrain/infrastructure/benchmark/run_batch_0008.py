...
def run_batch(seeds: int = 100):
    ...
    manifest = {
        ...
        "experiment": "Q007: Effect of Multi-step Horizon Planning on Functional Persistence",
    ...
    for ladder in ladders:
        ...
        subprocess.run([
            ...
            "--experiments", "E000", "E009_Control", "E009"
        ], check=True)
    ...
    expected_files = 18 * 3 * seeds
    sanity_report = f"""Sanity Report - Batch 0008
Expected Files: {expected_files} (18 constraints * 3 experiments * {seeds} seeds)
...
"""
    ...
    print(f"Batch 0008 completed in {elapsed:.2f} seconds.")

if __name__ == "__main__":
    import argparse
    print("Starting Batch 0008 execution...")
