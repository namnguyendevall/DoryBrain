...
def run_batch(seeds: int = 10):
    ...
    manifest = {
        ...
        "experiment": "E012: Causal Planner",
    ...
    for ladder in ladders:
        ...
        subprocess.run([
            ...
            "--seeds", str(seeds),
            "--out_base", raw_dir,
            "--experiments", "E000", "E012", "E012_Control"
        ], check=True)
    ...
    print(f"Batch 0011 completed in {elapsed:.2f} seconds.")

if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser()
    parser.add_argument("--seeds", type=int, default=100) # Recommend 100 per user instructions
