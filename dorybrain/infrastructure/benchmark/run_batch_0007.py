...
def run_batch(seeds: int = 100):
    ...
    manifest = {
        ...
        "experiment": "Q006: Effect of Predictive Internal Model on Functional Persistence",
    ...
    for ladder in ladders:
        ...
        subprocess.run([
            ...
            "--experiments", "E000", "E008_Control", "E008"
        ], check=True)
    ...
    sanity_report = f"""Sanity Report - Batch 0007
...
"""
    ...
    print(f"Batch 0007 completed in {elapsed:.2f} seconds.")
