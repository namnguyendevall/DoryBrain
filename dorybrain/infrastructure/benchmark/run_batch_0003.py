...
def run_batch(seeds: int = 100):
    ...
    for ladder in ladders:
        ...
        subprocess.run([
            ...
            "--experiments", "E000", "E001", "E004_Control", "E004"
        ], check=True)
    ...
    sanity_report = f"""Sanity Report - Batch 0003
...
"""
    ...
    print(f"Batch 0003 completed in {elapsed:.2f} seconds.")
