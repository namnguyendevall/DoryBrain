...
def run_batch(seeds: int = 10):
    ...
    manifest = {
        ...
        "experiment": "Q009: Environment Modification (Invest Gain and Decay)",
    ...
    for ladder in ladders:
        ...
        subprocess.run([
            ...
            "--seeds", str(seeds),
            "--out_base", raw_dir,
            "--experiments", "E000", "E011_A", "E011_B"
        ], check=True)
    ...
    print(f"Batch 0010 completed in {elapsed:.2f} seconds.")
