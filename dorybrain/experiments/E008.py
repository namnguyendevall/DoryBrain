...
class Actor:
    """
    E008: One-step Predictive Internal Model.
    Capability: Learns local transition model from experience and simulates one step ahead.
    """
