...
class Actor:
    """
    E014: Experience Replay Agent (Physics-Constrained Exploration Protocol)
    Capability: Offline Credit Assignment
    Mechanism: Online tabular Q-learning + Experience Replay (Uniform Random, FIFO)
    """
