...
class Actor:
    """
    E013A: Safe Q-Lambda Agent (Physics-Constrained Exploration Protocol)
    Capability: Temporal Credit Assignment
    Mechanism: Online tabular Q(λ) + Action Masking
    """
    def __init__(self, seed: int):
        ...
        # New Metrics for Protocol Validation
