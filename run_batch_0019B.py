...
def run_branch(branch_name, exp_name, selection_enabled, mutation_enabled, pop_size=100, generations=50, max_ticks=2000):
    ...
    with open(log_file, "w") as f_out, open(top_genomes_file, "w") as f_top:
        for gen in range(generations):
            ...
            print(f"[{branch_name}] Gen {gen} | Fit: {avg_fitness:.4f} | CIR: {cir:.2f} | Beta: {avg_beta:.1f} | Decay: {avg_decay:.3f} | Entropy: {entropy:.2f}")
...
if __name__ == "__main__":
    branches = [
        {"branch_name": "E019B_Behavior", "exp_name": "E019B_Behavior", "sel": True, "mut": True},
        {"branch_name": "E019C_Cognitive", "exp_name": "E019C_Cognitive", "sel": True, "mut": True},
        {"branch_name": "E019D_Frozen", "exp_name": "E019C_Cognitive", "sel": False, "mut": False}
    ]
    
    for b in branches:
        print(f"\n=== Starting Branch: {b['branch_name']} ===")
        run_branch(
            branch_name=b["branch_name"],
            exp_name=b["exp_name"],
            selection_enabled=b["sel"],
            mutation_enabled=b["mut"],
            pop_size=100,
            generations=50
        )
